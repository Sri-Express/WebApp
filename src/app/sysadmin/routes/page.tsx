...
export default function AdminRoutesPage() {
  ...
  // Utility function to handle clamp functionality for older browsers or runtime errors
  const clampValue = (min: number, val: number, max: number) => Math.min(Math.max(val, min), max);
  ...
  return (
    <div style={{ backgroundColor: currentThemeStyles.mainBg, minHeight: '100vh', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1600px', margin: '0 auto', padding: '0 1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', minWidth: 'fit-content' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <h1 style={{ fontSize: 'clamp(1.25rem, 2vw, 1.5rem)', fontWeight: 'bold', color: '#f1f5f9', margin: 0, whiteSpace: 'nowrap' }}>
                Route Management
              </h1>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
            ...
            <button onClick={() => setShowCreateRouteAdminModal(true)} style={{ backgroundColor: '#8b5cf6', color: 'white', padding: 'clamp(0.5rem, 2vw, 0.75rem) clamp(0.75rem, 3vw, 1.5rem)', borderRadius: '0.5rem', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: '500', fontSize: 'clamp(0.75rem, 2vw, 1rem)', whiteSpace: 'nowrap' }}>
              <UserPlusIcon width={16} height={16} />
              {!isMobile && <span>Create Route Admin</span>}
            </button>
            
            <Link href="/sysadmin/routes/add" style={{ textDecoration: 'none' }}>
              <button style={{ backgroundColor: '#10b981', color: 'white', padding: 'clamp(0.5rem, 2vw, 0.75rem) clamp(0.75rem, 3vw, 1.5rem)', borderRadius: '0.5rem', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: '500', fontSize: 'clamp(0.75rem, 2vw, 1rem)', whiteSpace: 'nowrap' }}>
                <PlusIcon width={16} height={16} />
                {!isMobile && <span>Create Route</span>}
              </button>
            </Link>
          </div>
        </div>
      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto', padding: 'clamp(1rem, 3vw, 2rem) clamp(0.5rem, 2vw, 1.5rem)', position: 'relative', zIndex: 10 }}>
        <div className="animate-fade-in-up" style={{ width: '100%' }}>
          
          {/* Filters Section */}
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 3vw, 1.5rem)', borderRadius: '1rem', boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', border: currentThemeStyles.glassPanelBorder, marginBottom: 'clamp(1rem, 3vw, 2rem)' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'flex', gap: 'clamp(0.5rem, 2vw, 1rem)', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-start' }}>
                <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)} style={{ padding: '0.5rem 1rem', borderRadius: '0.5rem', border: currentThemeStyles.inputBorder, backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, fontSize: '0.875rem', outline: 'none', position: 'relative', zIndex: 50 }}>
                  <option value="all" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>All Status</option>
                  <option value="pending" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>Pending</option>
                  <option value="approved" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>Approved</option>
                  <option value="rejected" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>Rejected</option>
                </select>

                <select value={filterRouteAdmin} onChange={(e) => setFilterRouteAdmin(e.target.value)} style={{ padding: '0.5rem 1rem', borderRadius: '0.5rem', border: currentThemeStyles.inputBorder, backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, fontSize: '0.875rem', outline: 'none', position: 'relative', zIndex: 50 }}>
                  <option value="all" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>All Routes</option>
                  <option value="assigned" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>With Route Admin</option>
                  <option value="unassigned" style={{ backgroundColor: currentThemeStyles.inputBg, color: currentThemeStyles.textPrimary, padding: '0.5rem' }}>Without Route Admin</option>
                </select>
              </div>

              {/* Quick Filter Buttons */}
              <div style={{ display: 'flex', gap: 'clamp(0.25rem, 1vw, 0.5rem)', alignItems: 'center', flexWrap: 'wrap', paddingTop: '0.5rem', borderTop: `1px solid ${currentThemeStyles.textMuted}` }}>
                <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', fontWeight: '500', marginRight: '0.5rem' }}>Quick:</span>
                <button 
                  onClick={() => setFilterStatus('approved')} 
                  style={{ 
                    backgroundColor: filterStatus === 'approved' ? '#10b981' : currentThemeStyles.quickActionBg, 
                    color: filterStatus === 'approved' ? 'white' : currentThemeStyles.textPrimary,
                    border: filterStatus === 'approved' ? 'none' : currentThemeStyles.quickActionBorder,
                    padding: 'clamp(0.375rem, 2vw, 0.5rem) clamp(0.5rem, 2vw, 1rem)', 
                    borderRadius: '0.5rem', 
                    cursor: 'pointer', 
                ...
                <button 
                  ...
                  style={{ 
                    backgroundColor: filterStatus === 'rejected' ? '#ef4444' : currentThemeStyles.quickActionBg, 
                    color: filterStatus === 'rejected' ? 'white' : currentThemeStyles.textPrimary,
                    border: filterStatus === 'rejected' ? 'none' : currentThemeStyles.quickActionBorder,
                    padding: 'clamp(0.375rem, 2vw, 0.5rem) clamp(0.5rem, 2vw, 1rem)', 
                    borderRadius: '0.5rem', 
                    cursor: 'pointer', 
                    fontSize: 'clamp(0.75rem, 2vw, 0.875rem)',
                ...
                <button 
                  ...
                  style={{ 
                    backgroundColor: filterStatus === 'pending' ? '#f59e0b' : currentThemeStyles.quickActionBg, 
                    color: filterStatus === 'pending' ? 'white' : currentThemeStyles.textPrimary,
                    border: filterStatus === 'pending' ? 'none' : currentThemeStyles.quickActionBorder,
                    padding: 'clamp(0.375rem, 2vw, 0.5rem) clamp(0.5rem, 2vw, 1rem)', 
                    borderRadius: '0.5rem', 
                    cursor: 'pointer', 
                    fontSize: 'clamp(0.75rem, 2vw, 0.875rem)',
                ...
                <button 
                  ...
                  style={{ 
                    backgroundColor: filterStatus === 'all' ? '#6366f1' : currentThemeStyles.quickActionBg, 
                    color: filterStatus === 'all' ? 'white' : currentThemeStyles.textPrimary,
                    border: filterStatus === 'all' ? 'none' : currentThemeStyles.quickActionBorder,
                    padding: 'clamp(0.375rem, 2vw, 0.5rem) clamp(0.5rem, 2vw, 1rem)', 
                    borderRadius: '0.5rem', 
                    cursor: 'pointer', 
                    fontSize: 'clamp(0.75rem, 2vw, 0.875rem)',
          ...
          {/* Route Statistics */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(clamp(200px, 25vw, 250px), 1fr))', gap: 'clamp(1rem, 2vw, 1.5rem)', marginBottom: 'clamp(1rem, 3vw, 2rem)' }}>
            {stats && [
              ...
              <div key={metric.label} style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: '1.5rem', borderRadius: '1rem', boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', border: currentThemeStyles.glassPanelBorder, animation: `fade-in-up 0.8s ease-out ${index * 0.1}s both` }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <metric.icon width={28} height={28} color={metric.color} />
                  <div>
                    <h3 style={{ color: metric.color, fontSize: '1.75rem', fontWeight: 'bold', margin: 0 }}>{metric.value}</h3>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontWeight: '600', fontSize: '0.875rem' }}>{metric.label}</p>
                    <p style={{ color: currentThemeStyles.textSecondary, margin: '0.125rem 0 0 0', fontSize: '0.75rem' }}>{metric.desc}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 3vw, 2rem)', borderRadius: '1rem', boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', border: currentThemeStyles.glassPanelBorder }}>
            <h2 style={{ color: currentThemeStyles.textPrimary, fontSize: 'clamp(1.25rem, 3vw, 1.5rem)', fontWeight: 'bold', marginBottom: 'clamp(1rem, 3vw, 1.5rem)', display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
              <MapIcon width={24} height={24} color="#F59E0B" />
              Route Applications ({routes.length})
            </h2>

            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(clamp(300px, 45vw, 500px), 1fr))', gap: 'clamp(1rem, 2vw, 1.5rem)' }}>
              {routes.map((route, index) => (
                <div key={route._id} style={{ backgroundColor: currentThemeStyles.quickActionBg, padding: 'clamp(1rem, 3vw, 1.5rem)', borderRadius: '0.75rem', border: currentThemeStyles.quickActionBorder, transition: 'all 0.3s ease', animation: `fade-in-up 0.6s ease-out ${index * 0.1}s both` }}>
                  ...
                  {/* Actions */}
                  <div style={{ display: 'flex', gap: 'clamp(0.25rem, 1vw, 0.5rem)', flexWrap: 'wrap', justifyContent: 'flex-start' }}>
                    {route.approvalStatus === 'pending' && (
                      <>
                        <button onClick={(e) => { e.stopPropagation(); setShowApprovalModal(route); }} disabled={actionLoading === `approve-${route._id}`} style={{ backgroundColor: '#10b981', color: 'white', padding: 'clamp(0.375rem, 1vw, 0.5rem) clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', border: 'none', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 'clamp(0.25rem, 1vw, 0.5rem)', opacity: actionLoading === `approve-${route._id}` ? 0.7 : 1, minWidth: 'fit-content' }}>
                          <CheckCircleIcon width={14} height={14} />
                          <span>{actionLoading === `approve-${route._id}` ? 'Approving...' : 'Approve'}</span>
                        </button>
                        
                        <button onClick={(e) => { e.stopPropagation(); setShowRejectionModal(route); }} disabled={actionLoading === `reject-${route._id}`} style={{ backgroundColor: '#ef4444', color: 'white', padding: 'clamp(0.375rem, 1vw, 0.5rem) clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', border: 'none', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 'clamp(0.25rem, 1vw, 0.5rem)', opacity: actionLoading === `reject-${route._id}` ? 0.7 : 1, minWidth: 'fit-content' }}>
                          <XCircleIcon width={14} height={14} />
                          <span>{actionLoading === `reject-${route._id}` ? 'Rejecting...' : 'Reject'}</span>
                        </button>
                      </>
                    )}
                    ...
                    {route.approvalStatus === 'approved' && (
                      <>
                        {hasRouteAdmin(route) ? (
                          <button onClick={(e) => { e.stopPropagation(); handleRemoveRouteAdmin(route._id); }} disabled={actionLoading === `remove-admin-${route._id}`} style={{ backgroundColor: '#dc2626', color: 'white', padding: 'clamp(0.375rem, 1vw, 0.5rem) clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', border: 'none', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 'clamp(0.25rem, 1vw, 0.5rem)', opacity: actionLoading === `remove-admin-${route._id}` ? 0.7 : 1, minWidth: 'fit-content' }}>
                            <UserIcon width={14} height={14} />
                            <span>{actionLoading === `remove-admin-${route._id}` ? 'Removing...' : 'Remove Admin'}</span>
                          </button>
                        ) : (
                          <button onClick={(e) => { e.stopPropagation(); setShowRouteAdminModal(route); }} disabled={getAvailableRouteAdmins().length === 0} style={{ backgroundColor: getAvailableRouteAdmins().length === 0 ? '#6b7280' : '#8b5cf6', color: 'white', padding: 'clamp(0.375rem, 1vw, 0.5rem) clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', border: 'none', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', cursor: getAvailableRouteAdmins().length === 0 ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', gap: 'clamp(0.25rem, 1vw, 0.5rem)', minWidth: 'fit-content' }}>
                    ...
                    <button onClick={(e) => { e.stopPropagation(); setSelectedRoute(route); }} style={{ backgroundColor: currentThemeStyles.quickActionBg, color: currentThemeStyles.textPrimary, padding: 'clamp(0.375rem, 1vw, 0.5rem) clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', border: currentThemeStyles.quickActionBorder, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 'clamp(0.25rem, 1vw, 0.5rem)', minWidth: 'fit-content' }}>
      ...
      {/* Route Details Modal */}
      {selectedRoute && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, backdropFilter: 'blur(8px)', padding: 'clamp(1rem, 5vw, 2rem)' }}>
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 4vw, 2rem)', borderRadius: '1rem', border: currentThemeStyles.glassPanelBorder, boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', maxWidth: 'clamp(350px, 90vw, 800px)', width: '100%', maxHeight: '85vh', overflow: 'auto' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'clamp(1rem, 3vw, 1.5rem)', gap: '1rem' }}>
              <h3 style={{ color: currentThemeStyles.textPrimary, fontSize: 'clamp(1rem, 4vw, 1.25rem)', fontWeight: 'bold', margin: 0, lineHeight: '1.2', wordBreak: 'break-word' }}>
                {selectedRoute.name} - Route Details
              </h3>
              <button onClick={() => setSelectedRoute(null)} style={{ backgroundColor: 'transparent', color: currentThemeStyles.textSecondary, border: 'none', cursor: 'pointer', fontSize: 'clamp(1.25rem, 4vw, 1.5rem)', minWidth: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ×
              </button>
            </div>

            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 'clamp(1rem, 3vw, 1.5rem)' }}>
              <div>
                <h4 style={{ color: currentThemeStyles.textPrimary, marginBottom: 'clamp(0.75rem, 2vw, 1rem)', fontSize: 'clamp(1rem, 3vw, 1.125rem)' }}>Route Information</h4>
                <div style={{ backgroundColor: currentThemeStyles.quickActionBg, padding: 'clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', marginBottom: 'clamp(0.75rem, 2vw, 1rem)', border: currentThemeStyles.quickActionBorder }}>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Route ID:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>{selectedRoute.routeId}</p>
                  </div>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Start Address:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>{selectedRoute.startLocation.address}</p>
                  </div>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>End Address:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>{selectedRoute.endLocation.address}</p>
                  </div>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Duration:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)' }}>{formatDuration(selectedRoute.estimatedDuration)}</p>
                  </div>
                </div>
              </div>

              <div>
                <h4 style={{ color: currentThemeStyles.textPrimary, marginBottom: 'clamp(0.75rem, 2vw, 1rem)', fontSize: 'clamp(1rem, 3vw, 1.125rem)' }}>Operator & Pricing</h4>
                <div style={{ backgroundColor: currentThemeStyles.quickActionBg, padding: 'clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', marginBottom: 'clamp(0.75rem, 2vw, 1rem)', border: currentThemeStyles.quickActionBorder }}>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Contact:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>{selectedRoute.operatorInfo.contactNumber}</p>
                  </div>
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Price per KM:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)' }}>{formatCurrency(selectedRoute.pricing.pricePerKm)}</p>
                  </div>
                  <div>
                    <span style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Amenities:</span>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: '0.25rem 0 0 0', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>
            ...
            {hasRouteAdmin(selectedRoute) && (
              <div style={{ backgroundColor: currentThemeStyles.quickActionBg, padding: 'clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', marginTop: 'clamp(0.75rem, 2vw, 1rem)', border: currentThemeStyles.quickActionBorder }}>
                <h4 style={{ color: currentThemeStyles.textPrimary, marginBottom: 'clamp(0.75rem, 2vw, 1rem)', fontSize: 'clamp(1rem, 3vw, 1.125rem)' }}>Route Administrator</h4>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem', flexWrap: 'wrap' }}>
                  <div style={{ flex: 1, minWidth: '200px' }}>
                    <p style={{ color: currentThemeStyles.textPrimary, margin: 0, fontWeight: '600', fontSize: 'clamp(0.875rem, 2vw, 1rem)', wordBreak: 'break-word' }}>
                      {selectedRoute.routeAdminId?.name}
                    </p>
                    <p style={{ color: currentThemeStyles.textSecondary, margin: '0.25rem 0', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', wordBreak: 'break-word' }}>
                      {selectedRoute.routeAdminId?.email}
                    </p>
                    <p style={{ color: currentThemeStyles.textSecondary, margin: 0, fontSize: 'clamp(0.625rem, 2vw, 0.75rem)' }}>
                      Assigned: {formatDateTime(selectedRoute.routeAdminAssignment?.assignedAt || '')}
                    </p>
                  </div>
                  <div style={{ backgroundColor: '#10b981', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '0.25rem', fontSize: 'clamp(0.625rem, 2vw, 0.75rem)', fontWeight: '600', whiteSpace: 'nowrap' }}>
                    ASSIGNED
                  </div>
                </div>
              </div>
            ...
            <div style={{ marginTop: 'clamp(1rem, 3vw, 1.5rem)', display: 'flex', justifyContent: 'flex-end', gap: 'clamp(0.5rem, 2vw, 1rem)', flexWrap: 'wrap' }}>
              <button onClick={() => setSelectedRoute(null)} style={{ backgroundColor: currentThemeStyles.quickActionBg, color: currentThemeStyles.textPrimary, padding: 'clamp(0.5rem, 2vw, 0.75rem) clamp(1rem, 3vw, 1.5rem)', border: currentThemeStyles.quickActionBorder, borderRadius: '0.5rem', cursor: 'pointer', fontSize: 'clamp(0.875rem, 2vw, 1rem)', fontWeight: '500', minWidth: 'fit-content' }}>
                Close
              </button>
            </div>
          </div>
      ...
      {/* Approval Modal */}
      {showApprovalModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1001, backdropFilter: 'blur(8px)', padding: 'clamp(1rem, 5vw, 2rem)' }}>
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 4vw, 2rem)', borderRadius: '1rem', border: currentThemeStyles.glassPanelBorder, boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', maxWidth: 'clamp(350px, 90vw, 500px)', width: '100%', maxHeight: '85vh', overflow: 'auto' }}>
            <h3 style={{ color: currentThemeStyles.textPrimary, fontSize: 'clamp(1rem, 4vw, 1.25rem)', fontWeight: 'bold', marginBottom: 'clamp(0.75rem, 3vw, 1rem)', lineHeight: '1.2' }}>
              Approve Route Application
            </h3>
            <p style={{ color: currentThemeStyles.textSecondary, marginBottom: 'clamp(0.75rem, 3vw, 1rem)', fontSize: 'clamp(0.875rem, 2vw, 1rem)', lineHeight: '1.4' }}>
            ...
            />
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 'clamp(0.5rem, 2vw, 1rem)', flexWrap: 'wrap' }}>
              <button 
                onClick={() => { setShowApprovalModal(null); setApprovalNotes(''); }} 
                style={{ 
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1001, backdropFilter: 'blur(8px)', padding: 'clamp(1rem, 5vw, 2rem)' }}>
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 4vw, 2rem)', borderRadius: '1rem', border: currentThemeStyles.glassPanelBorder, boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', maxWidth: 'clamp(350px, 90vw, 500px)', width: '100%', maxHeight: '85vh', overflow: 'auto' }}>
            ...
            <textarea 
              ...
              style={{ 
                width: '100%', 
                minHeight: 'clamp(90px, 15vw, 100px)', 
                backgroundColor: currentThemeStyles.inputBg, 
                border: currentThemeStyles.inputBorder, 
                borderRadius: '0.5rem', 
                padding: 'clamp(0.5rem, 2vw, 0.75rem)', 
      ...
      {showRouteAdminModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1001, backdropFilter: 'blur(8px)', padding: 'clamp(1rem, 5vw, 2rem)' }}>
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 4vw, 2rem)', borderRadius: '1rem', border: currentThemeStyles.glassPanelBorder, boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', maxWidth: 'clamp(350px, 90vw, 500px)', width: '100%', maxHeight: '85vh', overflow: 'auto' }}>
            ...
            <p style={{ color: currentThemeStyles.textSecondary, marginBottom: 'clamp(0.75rem, 3vw, 1rem)', fontSize: 'clamp(0.875rem, 2vw, 1rem)', lineHeight: '1.4', wordBreak: 'break-word' }}>
            ...
            {getAvailableRouteAdmins().length === 0 && (
              <div style={{ backgroundColor: 'rgba(124, 45, 18, 0.2)', padding: 'clamp(0.75rem, 2vw, 1rem)', borderRadius: '0.5rem', marginBottom: 'clamp(0.75rem, 3vw, 1rem)', border: '1px solid rgba(124, 45, 18, 0.3)' }}>
                <p style={{ color: currentThemeStyles.textPrimary, margin: 0, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', lineHeight: '1.4' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 'clamp(0.5rem, 2vw, 1rem)', flexWrap: 'wrap' }}>
              <button 
                onClick={() => { setShowRouteAdminModal(null); setSelectedRouteAdminId(''); }} 
                style={{ 
                  backgroundColor: currentThemeStyles.quickActionBg, 
                  color: currentThemeStyles.textPrimary, 
                  padding: 'clamp(0.5rem, 2vw, 0.75rem) clamp(1rem, 3vw, 1.5rem)', 
      ...
      {showCreateRouteAdminModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1001, backdropFilter: 'blur(8px)', padding: 'clamp(1rem, 5vw, 2rem)' }}>
          <div style={{ backgroundColor: currentThemeStyles.glassPanelBg, padding: 'clamp(1rem, 4vw, 2rem)', borderRadius: '1rem', border: currentThemeStyles.glassPanelBorder, boxShadow: currentThemeStyles.glassPanelShadow, backdropFilter: 'blur(12px)', maxWidth: 'clamp(350px, 90vw, 500px)', width: '100%', maxHeight: '90vh', overflow: 'auto' }}>
            <h3 style={{ color: currentThemeStyles.textPrimary, fontSize: 'clamp(1rem, 4vw, 1.25rem)', fontWeight: 'bold', marginBottom: 'clamp(0.75rem, 3vw, 1rem)', lineHeight: '1.2' }}>
              Create Route Admin
            </h3>
            
            <div style={{ marginBottom: 'clamp(0.75rem, 3vw, 1rem)' }}>
              <label style={{ color: currentThemeStyles.textSecondary, fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', display: 'block', marginBottom: '0.5rem' }}>
                Full Name *
              </label>
              <input 
                type="text" 
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 'clamp(0.5rem, 2vw, 1rem)', flexWrap: 'wrap' }}>
              <button 
                onClick={() => { setShowCreateRouteAdminModal(false); setNewRouteAdmin({ name: '', email: '', password: '', phone: '', routeId: '' }); }} 
                style={{ 
                  backgroundColor: currentThemeStyles.quickActionBg, 
                  color: currentThemeStyles.textPrimary, 
                  padding: 'clamp(0.5rem, 2vw, 0.75rem) clamp(1rem, 3vw, 1.5rem)', 
