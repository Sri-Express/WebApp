// src/app/sysadmin/analytics/page.tsx
"use client";
...
interface AnalyticsData {
  ...
  chartData: {
    ...
    deviceActivity: Array<{ date: string; online: number; offline: number; }>;
    tripVolume: Array<{ date: string; trips: number; revenue: number; }>;
    systemPerformance: Array<{ date: string; uptime: number; responseTime: number; }>;
  };
  topMetrics: {
    topRoutes: Array<{ name: string; trips: number; revenue: number; }>;
    deviceTypes: Array<{ type: string; count: number; percentage: number; }>;
    userActivity: Array<{ role: string; count: number; percentage: number; }>;
    alerts: Array<{ type: string; count: number; severity: 'high' | 'medium' | 'low'; }>;
  };
}
