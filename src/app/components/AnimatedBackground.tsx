// D:/SRI_EXPRESS/PublicPage/src/app/components/AnimatedBackground.tsx
'use client';
  ...
  return (
    <>
      ...
      <div style={{ position: 'absolute', inset: 0, background: currentThemeStyles.bgGradient, zIndex: 0, overflow: 'visible' }}>
        ...
        {/* School Bus */}
        <div className="animate-car-right animation-delay-3000" style={{ position: 'absolute', top: '15%', marginTop: '15px', left: '-140px', width: '140px', height: '65px', zIndex: 5, filter: 'drop-shadow(0 4px 3px rgba(0, 0, 0, 0.3))' }}>
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                {/* Main body */}
        ...
        {/* Motorcycle */}
        <div className="animate-car-right animation-delay-500" style={{ position: 'absolute', top: '60%', marginTop: '20px', left: '-60px', width: '60px', height: '35px', zIndex: 5, filter: 'drop-shadow(0 4px 3px rgba(0, 0, 0, 0.3))' }}>
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        {/* Taxi Cab */}
        <div className="animate-car-right animation-delay-8000" style={{ position: 'absolute', top: '60%', marginTop: '15px', left: '-110px', width: '110px', height: '50px', zIndex: 5, filter: 'drop-shadow(0 4px 3px rgba(0, 0, 0, 0.3))' }}>
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                {/* Main body */}
        ...
        {/* City Bus */}
        <div className="animate-car-right animation-delay-20000" style={{ position: 'absolute', top: '60%', marginTop: '5px', left: '-130px', width: '130px', height: '60px', zIndex: 5, filter: 'drop-shadow(0 4px 3px rgba(0, 0, 0, 0.3))' }}>
            <div style={{ position: 'relative', width: '100%', height: '100%' }}>
                {/* Main body */}
