...
export default function LoginPage() {
  ...
  // Animation keyframes defined as inline styles in a style tag
  const animationStyles = `
    ...
    .animate-steam { /* This class is for the train smoke, individual vehicles use inline animation with keyframe 'steam' */
    ...
    .animation-delay-600 { animation-delay: 0.6s; } /* Added for consistency if needed by new vehicles */
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* END: New Vehicle Components */}
        
        <audio
          src="/train-whistle.mp3"
          autoPlay
          loop={false}
          style={{ display: 'none' }}
        />
      ...
      <div style={{
        ...
        <div className="animate-fade-in-up form-container" style={{ // Added form-container class
          width: '100%',
          maxWidth: 'min(90%, 400px)', // Responsive width
          margin: '0 auto',
          boxSizing: 'border-box'
        }}>
          {/* Logo and Brand */}
          <div style={{
            ...
            <h1 style={{
              ...
              <span style={{ 
                fontSize: 'clamp(3.5rem, 12vw, 5rem)', // Responsive font size
                marginRight: '0.5rem',
            ...
            <p style={{
              marginTop: '0.5rem',
              color: '#1F2937', // Changed from white to dark gray for better contrast
          ...
          {/* Login Form Card */}
          <div className="form-card" style={{ // Added form-card class
            backgroundColor: 'rgba(255, 255, 255, 0.92)',
            padding: 'clamp(1.25rem, 4vw, 2rem)', // Responsive padding
            borderRadius: 'clamp(0.75rem, 3vw, 1rem)', // Responsive border radius
            ...
            <form onSubmit={handleSubmit} style={{ boxSizing: 'border-box' }}>
              {/* Email field */}
              <div style={{ marginBottom: '1.75rem', boxSizing: 'border-box' }}>
                <label 
                  htmlFor="email" 
                  style={{
                    display: 'block',
                ...
                <div style={{ position: 'relative', boxSizing: 'border-box' }}>
                  <input
                    ...
                    className="input-focus input-field" // Added input-field class
                    style={{
                      width: '100%',
                      padding: 'clamp(0.6rem, 2vw, 0.75rem)', // Responsive padding
                      paddingLeft: 'clamp(2.25rem, 6vw, 2.75rem)', // Space for icon
                      borderRadius: 'clamp(0.5rem, 2vw, 0.75rem)', // Responsive border radius
                      border: '2px solid rgba(209, 213, 219, 0.8)',
                      backgroundColor: 'rgba(255, 255, 255, 0.9)',
                      boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.05)',
                      fontSize: 'clamp(0.85rem, 2.5vw, 0.95rem)', // Responsive font size
                      transition: 'all 0.2s ease',
                      boxSizing: 'border-box',
                      height: 'clamp(2.75rem, 8vw, 3rem)' // Consistent height for touch targets
                    }}
                  />
                  <div style={{
                    position: 'absolute',
                ...
                <div style={{ position: 'relative', boxSizing: 'border-box' }}>
                  <input
                    ...
                    style={{
                      ...
                      padding: 'clamp(0.6rem, 2vw, 0.75rem)', // Responsive padding
                      paddingLeft: 'clamp(2.25rem, 6vw, 2.75rem)', // Space for icon
                      paddingRight: 'clamp(2.25rem, 6vw, 2.75rem)', // Space for toggle icon
                      borderRadius: 'clamp(0.5rem, 2vw, 0.75rem)', // Responsive border radius
                      border: '2px solid rgba(209, 213, 219, 0.8)',
                      backgroundColor: 'rgba(255, 255, 255, 0.9)',
                      boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.05)',
              ...
              <div className="remember-forgot" style={{ // Added remember-forgot class
                display: 'flex', 
                ...
                <div>
                  <Link
                    ...
                    onMouseOver={(e) => {
                      ...
                      e.currentTarget.style.borderBottom = '1px solid #B45309';
                    }}
                    onMouseOut={(e) => {
              ...
              <button
                ...
                style={{
                  ...
                  color: 'white',
                  fontWeight: '700',
                  padding: 'clamp(0.75rem, 2.5vw, 0.875rem)', // Responsive padding
                  borderRadius: 'clamp(0.5rem, 2vw, 0.75rem)', // Responsive border radius
                  border: 'none',
                  ...
                  justifyContent: 'center',
                  alignItems: 'center',
                  fontSize: 'clamp(0.95rem, 3vw, 1.1rem)', // Responsive font size
                  position: 'relative',
                  overflow: 'hidden',
                  boxSizing: 'border-box',
                  minHeight: 'clamp(2.75rem, 8vw, 3rem)' // Consistent height for touch targets
                }}
              >
                {loading ? (
                  <>
            ...
            <p style={{ color: '#ffffff', fontSize: '0.95rem' }}>
              ...
              <Link
                ...
                onMouseOver={(e) => {
                  ...
                  e.currentTarget.style.borderBottom = '1px solid #FBBF24';
                }}
                onMouseOut={(e) => {
