...
export default function MapLocationSelector({ 
  ...
  useEffect(() => {
    const loadGoogleMaps = () => {
      ...
      script.src = `https://maps.googleapis.com/maps/api/js?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY || 'YOUR_GOOGLE_MAPS_API_KEY_HERE'}&libraries=places`;
      script.async = true;
      script.defer = true;
  ...
  const handleCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        alert('Error getting current location. Please search for a location instead.');
      }
    );
  };
